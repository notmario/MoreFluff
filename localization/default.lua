			...
			j_mf_digital_exclusive = {
				...
				text = {
					...
					},
					{
						...
						"{C:inactive,s:0.8}until the end of the Ante. This Joker",
						"{C:inactive,s:0.8}gives {X:inactive,C:white,s:0.8}X0.5{C:inactive,s:0.8} Mult for each card in exile\"",
					}
				},
			},
		...
		Other = {
			...
			mf_alchemy_hit_the_road_perpetual = {
				...
				text = {
					...
					"until the end of the {C:attention}Ante{}. This {C:attention}Joker{}",
					"gives {X:mult,C:white}X0.5{} Mult for each card in {C:spectral}exile{}",
					"{C:inactive}(Currently {X:mult,C:white}X#1#{C:inactive} Mult)"
				}
			},
			mf_dilu_horse = {
