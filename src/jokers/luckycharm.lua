SMODS.Joker({
	...
	attributes = { "chance", "mult", "economy", },
	loc_vars = function(self, info_queue, center)
		...
		local new_numerator_2, new_denominator_2 =
			SMODS.get_probability_vars(center, 1, center.ability.extra.money_chance, "luckycharm_money")
		return {
			vars = {
				new_numerator,
				new_denominator,
		...
		if context.end_of_round and not context.individual and not context.repetition and not context.blueprint then
			if
				SMODS.pseudorandom_probability(
					...
					"lucky_charm_money",
					1,
					card.ability.extra.money_chance,
					"lucky_charm_money"
				)
			then
				return {
