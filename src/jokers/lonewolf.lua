        ...
        if context.joker_main then
            ...
            for _, other_card in pairs(G.jokers.cards) do
                if other_card ~= card then
                    if FLUFF.has_attribute(other_card, "chips") or FLUFF.has_attribute(other_card, "xchips") or FLUFF.has_attribute(other_card, "echips") or FLUFF.has_attribute(other_card, "hyperchips") then give_chips = false end
