    ...
    calculate = function(self, card, context)
        ...
        if context.cardarea == G.jokers and context.before then
            ...
            for _, other_card in pairs(cards) do
                G.E_MANAGER:add_event(Event({trigger = 'after',delay = 0.15,func = function() other_card:flip();play_sound('card1', 1);other_card:set_ability(G.P_CENTERS["m_mf_yucky"]);card:juice_up(0.3, 0.5);return true end }))
            end
