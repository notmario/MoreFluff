...
SMODS.Joker {
    ...
    calculate = function(self, card, context)
        ...
        if (G.GAME.blind and G.GAME.blind.in_blind) and (context.selling_self and (card.ability.extra.c_rounds >= card.ability.extra.rounds) and not context.blueprint) then
