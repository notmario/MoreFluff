SMODS.Joker {
    ...
    loc_vars = function(self, info_queue, center)
        if not G.deck or not G.deck.cards or #G.deck.cards == 0 then
            return { vars = { "no ", "cards ", "left,", "the deck ", "is ", "empty", colours = {G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,
            G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE} } }
        end
        if not next(SMODS.find_card("j_mf_burnerphone")) then
            return { vars = { "is ", "not ", "owned,", "you ", "get ", "nothing", colours = {G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,
            G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE} } }
        end
        ...
        if #cardlist == 1 then
            ...
            return { vars = { rank, "of ", suit, "that ", "is ", "all", colours = {rank_col,G.C.UI.TEXT_DARK,suit_col, 
            G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE,G.C.UI.TEXT_INACTIVE} } }
        end
