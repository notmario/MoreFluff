...
function SMODS.create_mod_badges(obj, badges)
	...
	if obj then
		...
		for i = 1, #badges do
			if badges[i].nodes[1].nodes[2].config.object and badges[i].nodes[1].nodes[2].config.object.content and badges[i].nodes[1].nodes[2].config.object.content.string == FLUFF.display_name then
